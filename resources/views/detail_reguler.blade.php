...
<head>
    ...
    <title>Umroh Reguler | Nasrotul Ummah</title>
    ...
    <style>
        ...
        .package-image-card {
            ...
            background: url('umroh_reguler_potrait.png') no-repeat center center/cover;
            height: 700px;
            border-radius: 10px;
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top shadow-sm">
        <div class="container">
            <a class="navbar-brand arabic-logo fw-bold" href="#">Nasrotul Ummah</a>
    ...
    <section class="package-hero d-flex align-items-center mt-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h1 class="display-5 fw-bold">Umroh Reguler</h1>
                    <p class="lead mb-1">
                        <span class="badge bg-warning text-dark me-2">9 Hari</span>
                    ...
                    <p class="mt-4">
                        ...
                        melaksanakan Ibadah Umroh ke Tanah Suci sekaligus berwisata ke kota Dubai.
                    </p>
                </div>
                <div class="col-md-6">
    ...
    <section class="booking-cta">
        <div class="container">
            <h3 class="fw-bold mb-3">Umroh Reguler 9 Hari</h3>
    ...
    <script src="jsscript3.js"></script>
</body>
