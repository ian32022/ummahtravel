...
<head>
    ...
    <style>
        ...
        .package-image-card {
            ...
            background: url('{{ asset("image/umroh_reguler_potrait.png") }}') no-repeat center center/cover, url('{{ asset("image/umroh_reguler_potrait.png") }}') no-repeat center center/cover;
            height: 700px;
            border-radius: 10px;
