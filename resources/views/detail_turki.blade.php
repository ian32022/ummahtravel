...
<head>
    ...
    <style>
        ...
        .package-image-card {
            ...
            background: url('{{ asset("image/umroh_turki_potrait.png") }}') no-repeat center center/cover, url('{{ asset("image/turki.jpeg") }}') no-repeat center center/cover, url('image/turki.jpeg') no-repeat center center/cover;
            height: 650px;
            border-radius: 20px;
