        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" href="./kelola.html">Kelola Paket Umroh</a></li>
                    <li class="nav-item"><a class="nav-link active" href="./pendaftar.html">Verifikasi Pembayaran</a></li>
                </ul>
            </div>
        </div>
    </nav>
